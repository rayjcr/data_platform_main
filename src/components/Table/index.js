...
export default {
  ...
  created () {
    ...
    this.localPagination = ['auto', false].includes(this.showPagination) && Object.assign({}, this.localPagination, {
  ...
  methods: {
    ...
    loadData (pagination, filters, sorter) {
      ...
      const parameter = Object.assign({
        pn: (pagination && pagination.current) ||
          this.showPagination && this.localPagination.current || this.pageNum,
        ps: (pagination && pagination.pageSize) ||
